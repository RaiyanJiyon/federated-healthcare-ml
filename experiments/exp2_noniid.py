...
from src.config.config import NUM_CLIENTS, NUM_ROUNDS, MAX_ITER, DECISION_THRESHOLD, DIRICHLET_ALPHA
...
def run_non_iid_experiment():
    ...
    alpha = DIRICHLET_ALPHA  # Dirichlet parameter (lower = more non-IID)
